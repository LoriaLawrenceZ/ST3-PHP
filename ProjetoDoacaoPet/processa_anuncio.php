...
//
// CRIANDO TABELA:
// CREATE TABLE anuncio(id SERIAL NOT NULL, fase VARCHAR(255) NOT NULL, tipo VARCHAR(255) NOT NULL, porte VARCHAR(255) NOT NULL, sexo VARCHAR(255) NOT NULL, pelagem_cor VARCHAR(255) NOT NULL, raca VARCHAR(255) NOT NULL, observacao VARCHAR(255) NOT NULL, email_usuario VARCHAR(250) NOT NULL, CONSTRAINT pk_id_anuncio PRIMARY KEY(id_anuncio), CONSTRAINT fk_email_usuario FOREIGN KEY(email_usuario) REFERENCES usuario(email));
//
...
if (!empty($_POST)) {
    ...
    if ($_POST['enviarDados'] == 'CAD') { // CADASTRAR!!!
        try {
            ...
            // Montar a SQL (pgsql)
            $sql = "INSERT INTO anuncio(fase, tipo, porte, sexo, pelagem_cor, raca, observacao, email_usuario) VALUES (:fase, :tipo, :porte, :sexo, :pelagem_cor, :raca, :observacao, :email_usuario)";
            // Preparar a SQL (pdo)
